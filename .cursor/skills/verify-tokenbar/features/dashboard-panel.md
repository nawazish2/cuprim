...
“Show TokenBar” opens the glass dashboard panel with provider cards/tabs for detailed quota metrics.
...
- **Open panel (manual).** Status menu → **Show TokenBar**. Panel appears with TokenBar chrome.
...
- Panel is not a normal document window; don’t look for it in the Dock as a separate app switcher entry beyond TokenBar itself
